...
#     # 미리보기(로컬스토리지 기반)
#     path("agreements/<int:pk>/preview/", views.agreement_preview, name="agreement_preview"),
...
urlpatterns = [
    ...
    # 레거시(그냥 새작성으로 보냄)
    path("agreement/preview/", RedirectView.as_view(url="/agreements/new/", permanent=True)),
]
