...
# ✅ 1. 설정
MODEL_PATH = r"efficientNetB0_0712_test3_best_burger_model.pth"
...
model.classifier = nn.Sequential(
    ...
    nn.Linear(1280, 1))
model.load_state_dict(torch.load(MODEL_PATH, map_location=device))  # 학습된 모델 불러오기
...
if __name__ == "__main__":
    # (1) 테스트셋 평가
    test_folder = r"C:\Users\baby3\ai_x\source\Project\0711~0713 성미정리\3.ml_data\1. 모델 구성\split_data\test"
    evaluate_testset(test_folder)

    # (2) 이미지 예측
    # ★ ★ ★ ★ ★ ★ ★ ★ ★ ★ ★ ★ ★  여기에 테스트용 이미지 바꾸기!!!!!!!
    image_path = r"C:\Users\baby3\OneDrive\바탕 화면\햄버거 test_8.jfif"
