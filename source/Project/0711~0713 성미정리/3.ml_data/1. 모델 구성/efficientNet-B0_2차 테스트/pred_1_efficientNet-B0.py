...
class_names = ['burger', 'non_burger']  # 순서가 중요한 경우 ImageFolder 써서 정확히 매칭해야 함

# ✅ 4. 모델 정의 및 로딩
model = models.efficientnet_b0(pretrained=False)  # pretrained는 False (이미 학습된 모델 불러올 예정)
model.classifier[1] = nn.Linear(1280, 2)  # 출력층 수정
...
if __name__ == "__main__":
    ...
    # (2) 이미지 예측
    image_path = r"C:\Users\baby3\OneDrive\바탕 화면\햄버거_인풋영_2.jpg"
